...
export class TransportationQuestionnaireComponent implements OnInit {
  ...
  transportationQuestions: QuestionItem[] = [
    ...
    <ShortAnswer> {id: 2, question: "What is the fuel efficiency (miles per gallon) of your car?", answer: "0", type: "ShortAnswer"},
    <ShortAnswer> {id: 3, question: "How many people do you carpool with?", answer: "0", type: "ShortAnswer"},
    <ShortAnswer> {id: 4, question: "How many times per week do you carpool to and from work?", answer: "0", type: "ShortAnswer"},
    <ShortAnswer> {id: 5, question: "How many times per week do you bus to and from work?", answer: "0", type: "ShortAnswer"},
    <ShortAnswer> {id: 6, question: "How many times per week do you bike or walk to and from work?", answer: "0", type: "ShortAnswer"}
  ];
