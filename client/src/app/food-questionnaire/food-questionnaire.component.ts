...
export class FoodQuestionnaireComponent implements OnInit {
  ...
  foodQuestions: QuestionItem[] = [
    ...
    <ShortAnswer> {id: 11, question: "How many servings of beans do you consume in 1 day? A serving of tofu is 1/4 cup which is approximately how much can fit in your palm.", answer: "3", type: "ShortAnswer"},
    <ShortAnswer> {id: 12, question: "How many servings of tofu do you consume in 1 day? A serving of tofu is 1/4 cup which is approximately how much can fit in your palm.", answer: "3", type: "ShortAnswer"},
    <ShortAnswer> {id: 13, question: "How many servings of vegetables do you consume in 1 day? A serving of vegetables is 1 cup which is approximately how much can fit in a clenched palm.", answer: "3", type: "ShortAnswer"},
    <ShortAnswer> {id: 14, question: "How many servings of milk do you consume in 1 day? A serving of milk is 1 cup.", answer: "3", type: "ShortAnswer"},
    <ShortAnswer> {id: 15, question: "How many servings of fruit do you consume in 1 day? A serving of fruit is approximately 1 medium whole fruit.", answer: "3", type: "ShortAnswer"},
    <ShortAnswer> {id: 16, question: "How many servings of cheese do you consume in 1 day? A serving of cheese is 1.5 oz which is approximately how much can fit in half your palm.", answer: "3", type: "ShortAnswer"}  
  ];
  prevPage = "";
